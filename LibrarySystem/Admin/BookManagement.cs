...
namespace LibrarySystem.Admin
{
    public partial class frmBookManagement : Form
    {
        ...
        {
            Functions.Functions.gen = "Select book.title as [Title], book.author as [Author], book.volume as [Volume], book.genre as [Genre], book.date_published as [Date Published], book.publisher as [Publisher], book.status as [Status] from book order by book.status ASC";
