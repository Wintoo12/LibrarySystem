    ...
    public partial class frmStudentManagement : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Functions.Functions.gen = "Update student set studentID = " + txtStudentID.Text + ", firstname = '" + FName + "',lastname = '" + LName + "', gender = '" + gender + "', year_level = '" 
                    + cmbYear.Text + "', department = '" + cmbDepartment.Text + "', course = '" + cmbCourse.Text + "', username = '" + txtUsername.Text + "', password = '" 
                    + txtPassword.Text + "', dateregistered = '" + dateTimePicker1.Value.ToString() + "', roleID = " + role + " where studentID =" + txtStudentID.Text + "";
